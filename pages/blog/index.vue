<template>
  <div>
    ...
    <Banner />
    <div>
      <div class="bg-slate-200 w-full  px-5 py-4 space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl" v-for="article of articles" :key="articles.slug">
              ...
              <div class="my-4 divide-y-2 divide-gray-700">
                <div class="py-6 flex flex-wrap md:flex-nowrap place-content-center">
                  <div class="mx-8 md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col justify-center text-right border-2 border-gray-400 border-opacity-60 rounded-lg px-5 md:justify-center m:text-center place-content-center">
                    <span class="font-semibold text-xl text-gray-900">Curso: {{article.curso}}</span>
                    <span class="font-semibold text-xl text-gray-900">Area: {{article.area}}</span>
                    <span class="mt-1 text-gray-500 text-sm">12 Jun 2019</span>
                  </div>
                  <div class="px-8 md:flex-grow">
